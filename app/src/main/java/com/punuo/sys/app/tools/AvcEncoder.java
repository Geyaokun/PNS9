...
public class AvcEncoder {
    ...
    public AvcEncoder() {
        ...
        YuvUtils.allocateMemo(1382400,0,1382400);
        MediaFormat mediaFormat = MediaFormat.createVideoFormat("video/avc", 1280, 720);
        mediaFormat.setInteger(MediaFormat.KEY_BIT_RATE, 1280*720*2);
...
//            outputStream.close();
    ...
    public byte[] offerEncoder(byte[] input) {
        ...
        byte[] dstYuv = new byte[1280*720* 3 / 2];
        byte[] dstYuv1 = new byte[1280*720* 3 / 2];
        //s9设备

        NV21ToNV12(input, yuv420, 1280, 720);
        input=yuv420;
        //s6设备
//        swapYV12toI420(input,1280,720);
//        yuvPic.scaleAndRotateYV12ToI420(i420bytes,dstYuv,1280,720,90,1280,720);
//        input=dstYuv;
